# Desktop helper contract fixtures

These synthetic examples are consumed by the real Swift and Go stream decoders
and state models, and round-tripped through the Go helper's response type.
