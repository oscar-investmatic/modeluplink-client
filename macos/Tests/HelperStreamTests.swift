...
@main struct HelperStreamTests {
    static func main() throws {
        ...
        let line = Data("{\"event\":\"progress\",\"stage\":\"download\",\"message\":\"Downloading…\",\"completed\":25,\"total\":100}\n".utf8)
        ...
        _ = try stream.append(Data("{\"ready\":true,\"api_key\":\"test-key\",\"name_suggestions\":[\"quiet-rover\",\"silver-comet\",\"bold-atlas\"]}\n".utf8))
