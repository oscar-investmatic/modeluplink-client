...
for size in [16, 32, 128, 256, 512] {
    for scale in [1, 2] {
        ...
        NSBezierPath(
            roundedRect: NSRect(
                x: side * 0.04, y: side * 0.04, width: side * 0.92, height: side * 0.92),
        ...
        let orbit = NSBezierPath(
            ovalIn: NSRect(x: side * 0.19, y: side * 0.19, width: side * 0.62, height: side * 0.62))
        ...
        NSBezierPath(
            ovalIn: NSRect(x: side * 0.22, y: side * 0.23, width: side * 0.07, height: side * 0.07)
        ).fill()
        image.unlockFocus()
