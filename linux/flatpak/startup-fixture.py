...
if len(sys.argv) != 2:
    raise SystemExit("Usage: startup-fixture.py prepare|state|restore")
action = sys.argv[1]
os.umask(0o077)
if action == "prepare":
    ...
    endpoint = {
        "id": "ep_flatpak_startup",
        "slug": "flatpak-startup",
    ...
    result = {
        "startup_disabled": cfg.get("startup_disabled", False),
