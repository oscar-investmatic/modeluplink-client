...
function Invoke-VerifiedSigning([string]$Path) {
...
try {
    ...
    Invoke-VerifiedSigning "$Output\modeluplink.exe"
    Invoke-VerifiedSigning "$Output\modeluplink-app.exe"
    ...
    Invoke-VerifiedSigning $Installer
